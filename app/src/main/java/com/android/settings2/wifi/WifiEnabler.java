...
public class WifiEnabler implements CompoundButton.OnCheckedChangeListener {
    ...
    private final BroadcastReceiver mReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            } else if (WifiManager.SUPPLICANT_STATE_CHANGED_ACTION.equals(action)) { // indicating that the state of establishing a connection to an access point has changed.
                if (!mConnected.get()) {
                    handleStateChanged(WifiInfo.getDetailedStateOf((SupplicantState) intent.getParcelableExtra(WifiManager.EXTRA_NEW_STATE)));
                }
            } else if (WifiManager.NETWORK_STATE_CHANGED_ACTION.equals(action)) {//indicating that the state of Wi-Fi connectivity has changed.
