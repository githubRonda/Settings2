...
class AccessPoint extends Preference {
    ...
    private WifiConfiguration mConfig; // 若不为null, 这表示当前这个网络是一个 saved network
    /* package */ScanResult mScanResult;

    private int mRssi;// 若是Integer.MAX_VALUE, 则Wifi out of range
    private WifiInfo mInfo;
    private DetailedState mState; // 若不等于null, 则表示是 active connection
